    ...
    function sv_wc_xml_export_order_item_format($order_data, $order)
    {
        ...
        switch($order->get_shipping_method()) {
            ...
            case 'Standard (5)':
                ...
                break;
            case 'Free shipping on orders over £500':
            case 'Free shipping on orders over £500 (1)':
            case 'Free shipping on orders over £500 (4)':
            case 'Free shipping on orders over £500 (5)':
                if($order->get_meta('_fbf_shipping_address_type') && $order->get_meta('_fbf_shipping_address_type')==='Commercial'){
        ...
        if($f_price > 0){
            ...
            switch($sales_id){
                ...
                case 64241:
                    ...
                    break;
                case 64108:
                    $f_name = 'sales_discount_ll';
                    break;
	            case 66718:
					$f_name = 'sales_discount_lm';
					break;
                default:
            ...
            if (strpos($c_name, 'checkdisc_') !== false) {
                switch ($c_name) {
                    ...
                    case 'checkdisc_52604':
                        ...
                        break;
                    case 'checkdisc_61792':
                        $c_name = 'sales_discount_mf';
                        break;
                    ...
                    case 'checkdisc_64108':
                        $c_name = 'sales_discount_ll';
                        break;
	                case 'checkdisc_66718':
						$c_name = 'sales_discount_lm';
						break;
                    default:
