    ...
    function sv_wc_xml_export_order_item_format($order_data, $order)
    {
        ...
        $new_format = [
            ...
            'Customer' => [
                ...
                'StatementName' => $name,
                'StatementAddress1' => $order->get_billing_address_1(),
                'StatementAddress2' => $order->get_billing_address_2(),
                'StatementTown' => $order->get_billing_city(),
                'StatementCounty' => $order->get_billing_state(),
                'StatementCountry' => $order->get_billing_country(),
                'StatementCountryCode' => $order->get_billing_country(),
