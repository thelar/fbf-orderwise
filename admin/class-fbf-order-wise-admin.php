 ...
 <SalesOrders>',
    ...
    function sv_wc_xml_export_order_item_format($order_data, $order)
    {
        ...
        $new_format = [
            ...
            'DeliveryGross' => $shipping_gross,
            'DeliveryNet' => $shipping_net,
            'DeliveryTax' => $shipping_tax,
            'DeliveryTaxCode' => $tax_code,
            'OrderGross' => $order->get_total(),
            'OrderNet' => $order->get_total() - ($order->get_total_tax() + $shipping_tax),
            'OrderTax' => $order->get_total_tax() + $shipping_tax,
